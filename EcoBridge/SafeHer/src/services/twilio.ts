...
export const twilioService = new TwilioWhatsAppService({
  accountSid: 'AC11f0dbf3fee11d789b12d95305cd739a',
  authToken: 'YOUR_AUTH_TOKEN', // You'll need to provide this
  fromNumber: 'YOUR_TWILIO_WHATSAPP_NUMBER', // Your Twilio WhatsApp number
});
